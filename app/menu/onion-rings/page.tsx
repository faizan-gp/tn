...
export const metadata: Metadata = {
  title: 'Onion Rings Preview — Tandoori Nook',
  description:
    'Colorful, detailed preview of our Crispy Onion Rings for delivery apps. See nutrition, allergens, sizes, dip options, and how we make them perfectly crispy.',
  openGraph: {
    title: 'Onion Rings Preview — Tandoori Nook',
    description:
      'Preview our Crispy Onion Rings, including nutrition, allergens, sizes, dips, and more. Order on Uber Eats or DoorDash.',
    type: 'website',
    images: [{ url: '/onion-rings-hero-square-og.jpg', width: 1200, height: 1200, alt: 'Onion Rings square hero' }],
  },
  twitter: {
    ...
    description:
      'Preview our Crispy Onion Rings, including nutrition, allergens, sizes, dips, and more. Order on Uber Eats or DoorDash.',
    images: ['/onion-rings-hero-square-og.jpg'],
  },
};
...
// ----------
// Content data (from Onion Rings component)
// ----------
const SIZES = [
  {
    key: 'regular',
    ...
    fat: 18,
    serves: 'Feeds 1',
    blurb: 'The perfect crispy side or snack.',
    img: '/onion-rings-regular.webp', // Image path retained but not used in this section
    alt: 'Regular size Onion Rings',
  },
  {
    key: 'large',
    name: 'Large',
    ...
    fat: 27,
    serves: 'Feeds 1–2',
    blurb: 'More rings for sharing (or not!).',
    img: '/onion-rings-large.webp', // Image path retained but not used in this section
    alt: 'Large size Onion Rings',
  },
  {
    key: 'party',
    name: 'Party Box',
    ...
    fat: 54,
    serves: 'Feeds 3–4',
    blurb: 'Enough crispy goodness for the whole crew.',
    img: '/onion-rings-party.webp', // Image path retained but not used in this section
    alt: 'Party Box of Onion Rings',
  },
] as const;

const DIP_OPTIONS = [
    { id: 'ketchup', name: 'Ketchup', price: 0, note: 'Classic tangy', img: '/dip-ketchup.webp', alt: 'Ketchup dip cup' },
    { id: 'ranch', name: 'Ranch', price: 1, note: 'Creamy herb', img: '/dip-ranch.webp', alt: 'Ranch dip cup' },
    { id: 'chipotle', name: 'Chipotle Aioli', price: 1, note: 'Smoky spice', img: '/dip-chipotle-aioli.webp', alt: 'Chipotle aioli dip cup' },
    { id: 'honey-mustard', name: 'Honey Mustard', price: 1, note: 'Sweet & tangy', img: '/dip-honey-mustard.webp', alt: 'Honey mustard dip cup' },
    { id: 'boom-boom', name: 'Boom Boom', price: 1, note: 'Garlic chili kick', img: '/dip-boom-boom.webp', alt: 'Boom boom sauce dip cup' },
] as const;
...
const CRUNCH_OPTION = {
  ...
  name: 'Extra Crunchy',
  price: 0.75,
  note: 'Double-dip breading',
  blurb: 'We give the rings an extra pass through our seasoned batter for an even thicker, more satisfying crunch.',
  img: '/onion-rings-extra-crisp.webp', // Image path for display
  alt: 'Extra crunchy onion rings with thicker batter',
} as const;

const CHAPTERS = [
  {
    title: 'The Slice',
    subtitle: 'Thick-cut sweet onions',
    description: 'We cut generous rings from sweet onions for maximum tenderness and bite.',
    why: 'Thicker cuts hold their structure and stay juicy inside the crust.',
    img: '/onion-rings-cut.webp',
    alt: 'Raw thick-cut onion rings',
  },
  {
    title: 'The Soak',
    subtitle: 'Cold seltzer batter base',
    description: 'A chilled, bubbly batter aerates the crust for a feather-light crunch.',
    why: 'Carbonation expands in hot oil to create micro-crisp layers.',
    img: '/onion-rings-soaked.webp',
    alt: 'Onion rings being dipped in batter',
  },
  {
    title: 'The Fry',
    subtitle: 'Golden-brown perfection',
    description: 'Fried to order and drained on racks—never steaming in the bag.',
    why: 'Proper draining preserves crunch and avoids sogginess.',
    img: '/onion-rings-fry.webp',
    alt: 'Onion rings frying in hot oil',
  },
  {
    title: 'The Dip',
    subtitle: 'Pair with your favorite sauce',
    description: 'From tangy honey mustard to zippy chipotle aioli, every bite gets a lift.',
    why: 'Acid and spice balance the richness of the fried crust.',
    img: '/onion-rings-final.webp',
    alt: 'Onion ring being dipped into sauce',
  },
] as const;

const REVIEWS = [
  { name: 'Evan T.', rating: 5, text: 'Light batter, huge crunch. Dips are on point.' },
  { name: 'Nora P.', rating: 5, text: 'Best rings in town. Get the honey mustard!' },
  { name: 'Sam R.', rating: 5, text: 'Stays crispy on delivery—miracle.' },
] as const;
...
// Page
// ----------
export default function OnionRingsPreviewPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'MenuItem',
    name: 'Onion Rings',
    description:
      'Thick-cut sweet onions in a light, crispy batter, fried golden brown. Available with various dipping sauces and an extra crunchy option.',
    image: '/onion-rings.webp',
    offers: SIZES.map((s) => ({
      '@type': 'Offer',
      priceCurrency: 'USD',
      price: s.price,
      itemOffered: { '@type': 'MenuItem', name: `${s.name} Onion Rings` },
      ...
      <div className="container mx-auto px-6 py-8 md:py-12">
        ...
        <header className="mb-10 md:mb-12">
          ...
          <h1 className={`${display.className} text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-gray-900 mt-4`}>
            Onion <span className="text-amber-600">Rings</span>
          </h1>
          <p className="text-lg text-gray-700 leading-relaxed max-w-2xl mt-4">
            Thick-cut, perfectly crispy, undeniably addictive. This preview shows exactly what you’ll get when you order on your favorite delivery app.
          </p>
          ...
          <figure className="mt-6 grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-6 items-center">
            ...
            <div className="relative aspect-[1/1] rounded-3xl overflow-hidden shadow-2xl border border-amber-200">
              <Image
                src="/onion-rings.webp"
                alt="Onion Rings square hero image with dipping sauce"
                fill
                priority
            ...
            <figcaption className="lg:pl-2">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                 <div className="bg-white rounded-2xl p-4 ring-1 ring-amber-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Light, crispy batter</p>
                </div>
                <div className="bg-white rounded-2xl p-4 ring-1 ring-blue-200 shadow-md">
                 ...
                 <div className="bg-white rounded-2xl p-4 ring-1 ring-violet-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">5+ Options Available</p>
                </div>
                <div className="bg-white rounded-2xl p-4 ring-1 ring-emerald-200 shadow-md">
                 ...
                 <div className="bg-white rounded-2xl p-4 ring-1 ring-green-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Extra Crunchy (+ $0.75)</p>
                </div>
                <div className="bg-white rounded-2xl p-4 ring-1 ring-slate-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">4.9/5 (512 reviews)</p>
                </div>
              </div>
              ...
              <p className="mt-3 text-xs text-gray-500">
                Featured: Regular size • Photos for illustration — actual packaging may vary.
              </p>
            </figcaption>
          </figure>
        </header>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-700 text-sm md:text-base">
                  This page is a visual guide to sizes and dips so you can pick your perfect onion rings before
        ...
        {/* ---------------------------------- */}
        {/* Dip & Crunch Options (NO DIP IMAGES) */}
        {/* ---------------------------------- */}
        <section aria-labelledby="options" className="mb-12">
           <div className="flex items-center gap-3 mb-6">
            <IconBadge tone="violet" size="md"><Zap className="w-5 h-5" aria-hidden /></IconBadge>
            <h2 id="options" className={`${display.className} text-3xl md:text-4xl font-bold text-gray-900`}>Dip & Crunch Options</h2>
          </div>

          {/* Extra Crunch Option (With Image) */}
           <div className="mb-8">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Extra Crunchy?</h3>
            <article className="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-gray-200 grid grid-cols-1 md:grid-cols-[1fr_2fr] items-center">
              <div className="relative aspect-[4/3] md:aspect-[1/1]">
                <Image
                  src={CRUNCH_OPTION.img}
                  alt={CRUNCH_OPTION.alt}
                  fill
              ...
              <div className="p-6">
                 <h4 className="text-xl font-bold text-gray-900">{CRUNCH_OPTION.name}</h4>
                 <p className="text-lg text-amber-600 font-semibold">+${CRUNCH_OPTION.price.toFixed(2)}</p>
                 <p className="mt-1 text-sm text-slate-600">{CRUNCH_OPTION.note}</p>
                 <p className="mt-2 text-gray-700">{CRUNCH_OPTION.blurb}</p>
              </div>
            </article>
           </div>
          ...
          <div>
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Choose Your Dips</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {DIP_OPTIONS.map((opt) => (
                <article key={opt.id} className="bg-white rounded-2xl shadow-lg border-2 border-gray-200 p-6 flex flex-col justify-between">
                  ...
                  <div> {/* Wrap text content */}
                     <h4 className="text-lg font-bold text-gray-900">{opt.name}</h4>
             ...
             <p className="mt-3 text-sm text-gray-600">Select your preferred dips when ordering on the delivery app.</p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-green-200">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">Sweet onions, quality spices, clean oil. No artificial flavors.</p>
            <a href="#" className="mt-4 text-sm text-green-700 font-semibold flex items-center gap-1">Our Suppliers <ExternalLink className="w-4 h-4" /></a>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-emerald-200">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">Recyclable packaging. Local onion sourcing when possible. Food waste composted.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-green-600 mt-0.5" /><span>Vented lid keeps rings ~85% crispy after a 20-min ride</span></li>
                ...
                <li className="flex items-start gap-2"><CheckCircle className="w-5 h-5 text-green-600 mt-0.5" /><span>Paper liner wicks oil for a lighter bite</span></li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <article className="p-0 md:p-6 border-0 md:border-2 md:border-gray-200 rounded-none md:rounded-2xl">
              <div className="flex items-center gap-3 mb-2 md:mb-3">
                ...
                <h3 className="text-xl font-bold text-gray-900">Typical Macros (Base Rings)</h3>
              </div>
              ...
              <ul className="space-y-2 text-gray-700">
                 <li className="flex items-center gap-3">
                  <IconBadge tone="amber" size="sm"><Wheat className="w-4 h-4" aria-hidden /></IconBadge>
                   Contains <strong>Gluten</strong> (batter). Cooked in shared fryers.
                </li>
                 <li className="flex items-center gap-3">
                  <IconBadge tone="slate" size="sm"><Milk className="w-4 h-4" aria-hidden /></IconBadge>
                  Ranch dip contains <strong>Dairy</strong>.
                </li>
                 <li className="flex items-center gap-3">
                  <IconBadge tone="green" size="sm"><CheckCircle className="w-4 h-4" aria-hidden /></IconBadge>
                  Rings are <strong>Vegetarian</strong>. Kitchen is <strong>Nut-Free</strong>.
                </li>
              </ul>
            </article>
          </div>
        ...
        <section aria-label="Order reminder" className="bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 rounded-3xl p-8 md:p-10 text-center text-white shadow-2xl mb-12">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-amber-50 mb-6">
              Choose Uber Eats or DoorDash to complete checkout. We’ll start frying your onion rings as soon as your order comes in.
            </p>
        ...
        <footer className="text-center text-sm text-slate-600">
          ...
          <p>Nutrition values are estimates for base onion rings; add-ons and dips will alter final nutrition content.</p>
        </footer>
      </div>
    </main>
  );
