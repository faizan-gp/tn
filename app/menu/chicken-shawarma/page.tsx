...
export const metadata: Metadata = {
  title: 'Chicken Shawarma Preview — Tandoori Nook',
  description:
    'Colorful, detailed preview of our Chicken Shawarma for delivery apps. See nutrition, allergens, sizes, wraps, heat levels, sourcing, and how we build it.',
  openGraph: {
    title: 'Chicken Shawarma Preview — Tandoori Nook',
    description:
      'Preview our Chicken Shawarma, including nutrition, allergens, sizes, wraps, and more. Order on Uber Eats or DoorDash.',
    type: 'website',
    images: [{ url: '/images/shawarma/shawarma-hero-square-og.jpg', width: 1200, height: 1200, alt: 'Chicken Shawarma square hero' }],
  },
  twitter: {
    ...
    description:
      'Preview our Chicken Shawarma, including nutrition, allergens, sizes, wraps, and more. Order on Uber Eats or DoorDash.',
    images: ['/images/shawarma/shawarma-hero-square-og.jpg'],
  },
};
...
// ----------
// Content data (updated sizes & richer wrap notes)
// ----------
const SIZES = [
  {
    key: 'regular',
    ...
    fat: 25,
    serves: 'Feeds 1',
    blurb: '12" wrap. Balanced meat-to-salad ratio. Ideal lunch size.',
    img: '/chicken-shawarma-regular.webp', // Image path retained but not used in this section
    alt: 'Regular chicken shawarma wrap with pickles and herbs',
  },
  {
    key: 'large',
    name: 'Large',
    ...
    fat: 33,
    serves: 'Hungry 1',
    blurb: 'Laffa-style. Extra chicken + fries option. Big appetite approved.',
    img: '/chicken-shawarma-large.webp', // Image path retained but not used in this section
    alt: 'Large laffa chicken shawarma cut in half to show filling',
  },
  {
    key: 'family',
    name: 'Family Platter',
    ...
    fat: 105,
    serves: 'Serves 3–4',
    blurb: 'Sliced chicken, pita, toum, tahini, salad & pickles. Sharing made easy.',
    img: '/chicken-shawarma-family-platter.webp', // Image path retained but not used in this section
    alt: 'Family platter with sliced chicken shawarma, pita, sauces, and salad',
  },
] as const;
...
const WRAPS = [
  {
    ...
    name: 'Pita',
    note: 'Classic pocket',
    bestFor: 'Everyday wrap, neat to eat',
    carbsTip: 'Standard carbs',
    hotTip: 'Great with extra pickles',
    img: '/chicken-shawarma-pita-bread.webp', // Image path retained but not used in this section
    alt: 'Warm pita bread',
  },
  {
    id: 'laffa',
    name: 'Laffa',
    note: 'Fluffy, generous',
    bestFor: 'Bigger appetites, more fillings',
    carbsTip: '+ ~15–20g carbs vs pita',
    hotTip: 'Add fries inside for the full experience',
    img: '/chicken-shawarma-laffa-bread.webp', // Image path retained but not used in this section
    alt: 'Soft laffa bread',
  },
  {
    id: 'lettuce',
    name: 'Lettuce Wrap',
    note: '−18g carbs • gluten-free',
    bestFor: 'Lighter feel, extra crunch',
    carbsTip: 'Lowest carbs',
    hotTip: 'Ask for sauce on the side',
    img: '/chicken-shawarma-lettuce-wrap.webp', // Image path retained but not used in this section
  ...
  },
  {
    ...
    carbsTip: 'Bread-free',
    hotTip: 'Add hummus for creaminess',
    img: '/chicken-shawarma-plate.webp', // Image path retained but not used in this section
    alt: 'Shawarma plate with salad',
  },
] as const;

const HEAT_LEVELS = [
  { id: 'mild', label: 'Mild', flames: 1, notes: 'Gentle warmth', shu: '0–1,000 SHU', img: '/chicken-shawarma-mild-hot.webp', alt: 'Mild peppers' },
  { id: 'medium', label: 'Medium', flames: 2, notes: 'Balanced kick', shu: '2,000–5,000 SHU', img: '/chicken-shawarma-medium-hot.webp', alt: 'Medium spice mix' },
  { id: 'hot', label: 'Hot', flames: 3, notes: 'True heat lovers', shu: '5,000–10,000 SHU', img: '/chicken-shawarma-hot.webp', alt: 'Hot chilies' },
  { id: 'extra-hot', label: 'Extra-Hot', flames: 4, notes: 'House chili paste', shu: '15,000–30,000 SHU', img: '/chicken-shawarma-extra-hot.webp', alt: 'Chili paste' },
] as const;

const CHAPTERS = [
  {
    title: 'The Marinade',
    subtitle: '24-hour yogurt & spice bath',
    description:
      'Citrus, garlic, cardamom, cumin, and paprika with a touch of yogurt tenderize the chicken while locking in deep aroma.',
    why: 'Cold marination loosens fibers so the chicken stays juicy after high-heat roasting.',
    img: '/chicken-shawarma-marinade.webp',
    alt: 'Chicken marinating with spices and yogurt',
  },
  {
    title: 'The Roast',
    subtitle: 'Vertical rotisserie heat',
    description:
      'Stacked thighs baste themselves as they turn. Edges crisp, centers stay succulent.',
    why: 'Continuous rotation renders fat and re-bastes each layer for even browning.',
    img: '/chicken-shawarma-grill-roast.webp',
    alt: 'Vertical rotisserie shawarma cone roasting',
  },
  {
    title: 'The Shave',
    subtitle: 'Thin ribbons of joy',
    description:
      'Shaved to order so the crispy bits land straight into your wrap.',
    why: 'Shaving to order preserves browned edges and keeps juices in the meat.',
    img: '/chicken-shawarma-shaved-pieces.webp',
    alt: 'Chef shaving crispy shawarma slices',
  },
  {
    title: 'The Wrap',
    subtitle: 'Toum, tahini, pickles, herbs',
    description:
      'Garlic toum, tahini drizzle, tomato-cucumber salad, parsley, and punchy pickles — a calibrated balance of fat, acid, and crunch.',
    why: 'Acid & herbs cut richness; sesame tahini adds nutty depth and body.',
    img: '/chicken-shawarma.webp',
    alt: 'Shawarma wrap assembly with sauces and herbs',
  },
] as const;

const REVIEWS = [
  { name: 'Yasmin A.', rating: 5, text: 'As close to Amman as it gets. The toum is perfect.' },
  { name: 'Dev P.', rating: 5, text: 'Juicy, well-spiced, and still warm on delivery.' },
  { name: 'Marco G.', rating: 5, text: 'Laffa with fries inside = undefeated combo.' },
] as const;
...
const OTHER_ITEMS = [
  ...
  },
  {
    ...
    alt: 'Mac & Cheese with toppings',
    from: 11,
  },
  {
    name: 'Cheese Sticks',
    href: '/menu/cheese-sticks',
    img: '/cheese-sticks.webp',
    alt: 'Cheese sticks with marinara sauce',
    from: 7,
  },
] as const;
...
// Page
// ----------
export default function ChickenShawarmaPreviewPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'MenuItem',
    name: 'Chicken Shawarma',
    description:
      'Fire-kissed chicken shawarma with toum, tahini, tomato-cucumber salad, parsley, and pickles. Multiple sizes, wraps, and heat levels available.',
    image: '/images/shawarma/shawarma-hero-square.webp',
    offers: SIZES.map((s) => ({
      '@type': 'Offer',
      priceCurrency: 'USD',
      price: s.price,
      itemOffered: { '@type': 'MenuItem', name: `${s.name} Chicken Shawarma` },
      ...
      <div className="container mx-auto px-6 py-8 md:py-12">
        ...
        <header className="mb-10 md:mb-12">
          ...
          <h1 className={`${display.className} text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-gray-900 mt-4`}>
            Chicken <span className="text-[#c8282d]">Shawarma</span>
          </h1>
          <p className="text-lg text-gray-700 leading-relaxed max-w-2xl mt-4">
            Fire-kissed, herb-bright, and seriously addictive. This preview shows exactly what you’ll get when you order on your favorite delivery app.
          </p>
          ...
          <figure className="mt-6 grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-6 items-center">
            ...
            <div className="relative aspect-[1/1] rounded-3xl overflow-hidden shadow-2xl border border-amber-200">
              <Image
                src="/chicken-shawarma.webp"
                alt="Chicken shawarma wrap square hero with toum and pickles"
                fill
                priority
            ...
            <figcaption className="lg:pl-2">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <div className="bg-white rounded-2xl p-4 ring-1 ring-amber-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">30–120g depending on size</p>
                </div>
                <div className="bg-white rounded-2xl p-4 ring-1 ring-blue-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Strict prep & handling</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-4 ring-1 ring-violet-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Pita, Laffa, Lettuce, Plate</p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-4 ring-1 ring-slate-200 shadow-md">
                  ...
                  <p className="text-sm text-gray-600 mt-1">4.9/5 (1,100+ reviews)</p>
                </div>
              </div>
              ...
              <p className="mt-3 text-xs text-gray-500">
                Featured: Large Laffa with fries inside • Photos for illustration — actual packaging may vary.
              </p>
            </figcaption>
          </figure>
        </header>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-700 text-sm md:text-base">
                  This page is a visual guide to sizes, wraps, and heat levels so you can build your favorite combo before
        ...
        <section aria-labelledby="sizes" className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <IconBadge tone="rose" size="md"><Package className="w-5 h-5" aria-hidden /></IconBadge> {/* Changed icon tone */}
            ...
            {SIZES.map((s) => (
              <article key={s.key} className="bg-white rounded-2xl shadow-lg border-2 border-gray-200 p-6">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <p className="text-2xl font-extrabold text-[#c8282d]">${s.price}</p>
                </div>
            ...
            {CHAPTERS.map((c, i) => (
              <article key={i} className="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-gray-200">
                ...
                <div className="p-6">
                  ...
                  <div className="bg-amber-50 p-4 rounded-xl border-l-4 border-[#c8282d] mt-4">
        ...
        <section aria-labelledby="reviews" className="bg-white rounded-3xl shadow-xl p-8 mb-12 border-2 border-gray-200">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-500">(1,100+ reviews)</span>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {REVIEWS.map((r, idx) => (
              <article key={idx} className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-12 h-12 bg-[#c8282d] rounded-full flex items-center justify-center text-white font-bold text-lg">
                    {r.name[0]}
                  </div>
                  <div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-green-200">
            ...
            <button className="mt-4 text-sm text-green-700 font-semibold flex items-center gap-1">View Halal Certificate <ExternalLink className="w-4 h-4" /></button>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-blue-200">
            ...
            <button className="mt-4 text-sm text-blue-700 font-semibold flex items-center gap-1">See Our Kitchen <ExternalLink className="w-4 h-4" /></button>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-emerald-200">
            ...
            <button className="mt-4 text-sm text-emerald-700 font-semibold flex items-center gap-1">Our Impact <ExternalLink className="w-4 h-4" /></button>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <article className="p-0 md:p-6 border-0 md:border-2 md:border-gray-200 rounded-none md:rounded-2xl">
              <div className="flex items-center gap-3 mb-2 md:mb-3">
                ...
                <h3 className="text-xl font-bold text-gray-900">Typical Macros</h3>
              </div>
                ...
                {SIZES.map((s) => (
                  <div key={s.key} className="rounded-xl bg-white p-4 ring-1 ring-amber-100 shadow-sm">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-[#c8282d] font-bold">${s.price}</div>
                    </div>
              ...
              <p className="mt-3 text-xs text-gray-500">Values are estimates for standard builds; customizations on apps will change macros.</p>
            </article>
            ...
            <article className="p-0 md:p-6 border-0 md:border-2 md:border-gray-200 rounded-none md:rounded-2xl">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-center gap-3">
                  ...
                  Marinade includes yogurt (dairy). Ask for olive-oil & lemon alternative where available.
                </li>
                <li className="flex items-center gap-3">
                  <IconBadge tone="amber" size="sm"><Wheat className="w-4 h-4" aria-hidden /></IconBadge>
                  Pita & laffa contain gluten. Choose lettuce wrap or plate for gluten-free.
                </li>
                <li className="flex items-center gap-3">
                  <IconBadge tone="emerald" size="sm"><Leaf className="w-4 h-4" aria-hidden /></IconBadge>
                  Tahini contains sesame (common allergen).
                </li>
                <li className="flex items-center gap-3">
                  <IconBadge tone="slate" size="sm"><Info className="w-4 h-4" aria-hidden /></IconBadge>
                  Kitchen also handles nuts & soy; cross-contact possible.
                </li>
              </ul>
            </article>
          </div>
        ...
        <section aria-label="Order reminder" className="bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 rounded-3xl p-8 md:p-10 text-center text-white shadow-2xl mb-12">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-amber-50 mb-6">
              Choose Uber Eats or DoorDash to complete checkout. We’ll start cooking as soon as your order comes in.
            </p>
